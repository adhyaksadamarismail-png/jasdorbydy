...
const formattedProducts = MENU.map(item => {
  ...
  const singleItemNames = ["Air Mineral", "Fresh Lemonade", "Sugar Donut", "Roti Coklat Klasik", "Butter Croissant"];
  const isSingle = singleItemNames.includes(item.name) || !!item.isSingle;
